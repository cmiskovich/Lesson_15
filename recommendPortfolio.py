...
def get_investment_recommendation(risk_level):
    ...
    risk_levels = {
        ...
        "medium": "40% bonds (AGG), 50% equities (SPY), 10% Crypto (BTC)",
        "high": "20% bonds (AGG), 60% equities (SPY), 20% Crypto (BTC)",
    }
    ...
    if age is not None:
        ...
        if age < 0:
            return build_validation_result(
                False,
                "age",
                "Your age is invalid, can you provide an age greater than zero and less than sixty five?",
            )
        elif age >= 65:
            return build_validation_result(
                False,
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                ...
                "provide an amount higher than 5,000.",
            )
